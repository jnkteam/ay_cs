namespace KuaiCard.BLL.User
{
    ...
    {
        public int Add(KuaiCard.Model.User.userspaybank model)
        {
        ...
        public KuaiCard.Model.User.userspaybank DataRowToModel(DataRow row)
        {
            KuaiCard.Model.User.userspaybank userspaybank = new KuaiCard.Model.User.userspaybank();
            if (row != null)
            {
        ...
        public KuaiCard.Model.User.userspaybank GetModel(int userid)
        {
            StringBuilder builder = new StringBuilder();
        ...
        public bool Update(KuaiCard.Model.User.userspaybank model)
        {
            StringBuilder builder = new StringBuilder();
