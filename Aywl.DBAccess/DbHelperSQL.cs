namespace Aywl.DBAccess
{
    ...
    {
        public static string connectionString = RuntimeSetting.ConnectString;
        ...
        private static SqlCommand BuildIntCommand(SqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            ...
            command.Parameters.Add(new SqlParameter("ReturnValue", SqlDbType.Int, 10, ParameterDirection.ReturnValue, false, 0, 0, string.Empty, DataRowVersion.Default, null));
            return command;
        }
                    ...
                    try
                    {
                        ...
                        foreach (CommandInfo info in cmdList)
                        {
                            ...
                            if ((info.EffentNextType == EffentNextType.WhenHaveContine) || (info.EffentNextType == EffentNextType.WhenNoHaveContine))
                            {
                                ...
                                bool flag2 = Convert.ToInt32(obj2) > 0;
        ...
        public static bool Exists(string strSql)
        {
            ...
            return (((!object.Equals(single, null) && !object.Equals(single, DBNull.Value)) ? int.Parse(single.ToString()) : 0) != 0);
        }
