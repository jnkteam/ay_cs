    ...
    public class CardOrderList : AgentPageBase
    {
        ...
        protected void rptOrders_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            url = string.Concat(new object[] { 
                url, "&ctype=", this.ddlChannelType.SelectedValue, "&userid=", this.txtuserid.Text, "&ka=", this.txtCardNo.Text, "&stime=", this.StimeBox.Text, "&etime=", this.EtimeBox.Text, "&mid=", this.ddlmange.SelectedValue, "&orderid=", this.txtOrderId.Text, "&userorder=", 
