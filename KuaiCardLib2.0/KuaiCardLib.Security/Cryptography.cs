...
namespace KuaiCardLib.Security
{
	public sealed class Cryptography
	{
        ...
        private static byte[] RijndaelIV
        {
            get
            {
                return Cryptography.MD5StrToByte("Provider");
            }
        }
        ...
        private static byte[] RijndaelKey
        {
            get
            {
                ...
                Array.Copy(Cryptography.MD5StrToByte("Provider"), 0, numArray, 0, 16);
                Array.Copy(Cryptography.MD5ByteToByte(Cryptography.MD5StrToByte("Provider")), 0, numArray, 16, 16);
                return numArray;
            }
        }
