namespace OriginalStudio.BLL.APP
{
    ...
    public class apprecharge
    {
        ...
        public int Add(OriginalStudio.Model.APP.apprecharge model)
        {
            int num;
            ...
            DataBase.ExecuteScalar(CommandType.StoredProcedure, "proc_apprecharge_ADD", parameters);
        ...
        public OriginalStudio.Model.APP.apprecharge DataRowToModel(DataRow row)
        {
            OriginalStudio.Model.APP.apprecharge apprecharge = new OriginalStudio.Model.APP.apprecharge();
            if (row != null)
            {
        ...
        {
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10) };
            parameters[0].Value = id;
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_apprecharge_Delete", parameters) > 0;
        }
        ...
        public bool Exists(int id)
        {
            ...
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10) };
            parameters[0].Value = id;
            return Convert.ToInt32(DataBase.ExecuteScalar(CommandType.StoredProcedure, "proc_apprecharge_Exists", null)) > 0;
        }
        ...
        public int GetMaxId()
        {
            return 0;// DbHelperSQL.GetMaxID("id", "apprecharge");
        }

        public OriginalStudio.Model.APP.apprecharge GetModel(string orderid)
        {
            SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@orderid", SqlDbType.VarChar, 30) };
            parameters[0].Value = orderid;
            OriginalStudio.Model.APP.apprecharge apprecharge = new OriginalStudio.Model.APP.apprecharge();
            DataSet set = DataBase.ExecuteDataset(CommandType.StoredProcedure, "proc_apprecharge_GetModel", parameters);
        ...
        public int GetRecordCount(string strWhere)
        {
            ...
            return Convert.ToInt32(DataBase.ExecuteScalar(CommandType.Text, builder.ToString(), null));
        }
        ...
        public bool Update(OriginalStudio.Model.APP.apprecharge model)
        {
            int rowsAffected = 0;
            SqlParameter[] parameters = new SqlParameter[] { 
                new SqlParameter("@id", SqlDbType.Int, 10), 
            ...
            return (DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_apprecharge_Update", parameters) > 0);
        }
    }
}
