namespace KuaiCard.DAL.Withdraw
{
    ...
    public class settledAgent
    {
        ...
        public int Add(KuaiCard.Model.Withdraw.settledAgent model)
        {
            ...
            DbHelperSQL.RunProcedure("proc_settledAgent_ADD", (IDataParameter[]) parameterArray, out num);
        ...
        public int Audit(string trade_no, int auditstatus, int auditUser, string auditUserName)
        {
            ...
            commandParameters[5].Direction = ParameterDirection.Output;
            DataBase.ExecuteDataset(CommandType.StoredProcedure, "proc_settledAgent_audit", commandParameters);
            return Convert.ToInt32(commandParameters[5].Value);
        }
        ...
        public KuaiCard.Model.Withdraw.settledAgent DataRowToModel(DataRow row)
        {
            KuaiCard.Model.Withdraw.settledAgent agent = new KuaiCard.Model.Withdraw.settledAgent();
            if (row != null)
            {
        ...
        public bool Delete(int id)
        {
            ...
            DbHelperSQL.RunProcedure("proc_settledAgent_Delete", (IDataParameter[]) parameterArray, out rowsAffected);
        ...
        public bool Exists(string trade_no)
        {
            ...
            return (DbHelperSQL.RunProcedure("proc_settledAgent_Exists", (IDataParameter[]) parameterArray, out num) == 1);
        }
        ...
        public KuaiCard.Model.Withdraw.settledAgent GetModel(int id)
        {
            ...
            parameterArray[0].Value = id;
            KuaiCard.Model.Withdraw.settledAgent agent = new KuaiCard.Model.Withdraw.settledAgent();
            DataSet set = DbHelperSQL.RunProcedure("proc_settledAgent_GetModel", (IDataParameter[]) parameterArray, "ds");
        ...
        public KuaiCard.Model.Withdraw.settledAgent GetModel(string trade_no)
        {
            ...
            parameterArray[0].Value = trade_no;
            KuaiCard.Model.Withdraw.settledAgent agent = new KuaiCard.Model.Withdraw.settledAgent();
            DataSet set = DbHelperSQL.RunProcedure("proc_settledAgent_GetModel2", (IDataParameter[]) parameterArray, "ds");
            if (set.Tables[0].Rows.Count > 0)
            {
                return this.DataRowToModel(set.Tables[0].Rows[0]);
            }
        ...
        public bool Update(KuaiCard.Model.Withdraw.settledAgent model)
        {
            ...
            parameterArray[30].Value = model.notifystatus;
            parameterArray[0x1f].Value = model.callbackText;
            DbHelperSQL.RunProcedure("proc_settledAgent_Update", (IDataParameter[]) parameterArray, out rowsAffected);
            return (rowsAffected > 0);
        }
    }
}
