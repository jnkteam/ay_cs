	...
	public sealed class Cryptography
	{
		...
		private static byte[] RijndaelKey
		{
			get
			{
				...
				Array.Copy(Cryptography.MD5StrToByte("广东省中山市能龙软件科技有限公司"), 0, numArray, 0, 16);
				Array.Copy(Cryptography.MD5ByteToByte(Cryptography.MD5StrToByte("WWW.NENGLONG.COM")), 0, numArray, 16, 16);
				return numArray;
			}
		}
