namespace KuaiCard.BLL.Payment
{
    ...
    public class PayPriceConverFactory
    {
        ...
        {
            SqlParameter[] prams = new SqlParameter[] { new SqlParameter("@ID", SqlDbType.Int, 10), new SqlParameter("@Pri_Type", SqlDbType.Int, 10), new SqlParameter("@Value", SqlDbType.Money, 8), new SqlParameter("@Conv_PriType", SqlDbType.Int, 10), new SqlParameter("@Created", SqlDbType.DateTime), new SqlParameter("@IsOpen", SqlDbType.Bit) };
        ...
        {
            SqlParameter[] prams = new SqlParameter[] { new SqlParameter("@value", SqlDbType.Money, 8), new SqlParameter("@pay", SqlDbType.Int, 10) };
            prams[0].Value = value;
            prams[1].Value = pay;
            PayPriceConver conver = new PayPriceConver();
            DataSet ds = null;
