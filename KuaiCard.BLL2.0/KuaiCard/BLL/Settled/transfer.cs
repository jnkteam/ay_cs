namespace KuaiCard.BLL.Settled
{
    ...
    public class transfer
    {
        ...
        public int Add(KuaiCard.Model.Settled.transfer model)
        {
            try
            {
                int num;
                SqlParameter[] parameters = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10), new SqlParameter("@year", SqlDbType.Int, 10), new SqlParameter("@month", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@touserid", SqlDbType.Int, 10), new SqlParameter("@amt", SqlDbType.Decimal, 9), new SqlParameter("@charge", SqlDbType.Decimal, 9), new SqlParameter("@remark", SqlDbType.VarChar, 200), new SqlParameter("@status", SqlDbType.Int, 10), new SqlParameter("@addtime", SqlDbType.DateTime), new SqlParameter("@updatetime", SqlDbType.DateTime) };
                ...
                DbHelperSQL.RunProcedure("proc_transfer_add", parameters, out num);
        ...
        public KuaiCard.Model.Settled.transfer DataRowToModel(DataRow row)
        {
            KuaiCard.Model.Settled.transfer transfer = new KuaiCard.Model.Settled.transfer();
            if (row != null)
            {
        ...
        public KuaiCard.Model.Settled.transfer GetModel(int id)
        {
            StringBuilder builder = new StringBuilder();
        ...
        public bool Update(KuaiCard.Model.Settled.transfer model)
        {
            StringBuilder builder = new StringBuilder();
