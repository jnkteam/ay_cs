namespace OriginalStudio.BLL.Channel
{
    ...
    public class Channelsupplier
    {
        public bool Add(ChannelSupplier model)
        {
            ...
            builder.Append("@typeid,@suppid,@userid,@isopen,@payrate)");
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@typeid", SqlDbType.Int, 10), new SqlParameter("@suppid", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@isopen", SqlDbType.Bit, 1), new SqlParameter("@payrate", SqlDbType.Decimal, 9) };
        ...
        public bool Delete(int typeid, int suppid)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@typeid", SqlDbType.Int, 10), new SqlParameter("@suppid", SqlDbType.Int, 10) };
        ...
        public static DataSet GetList(int typeid, int userid)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@typeid", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10) };
            commandParameters[0].Value = typeid;
        ...
        {
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@typeid", SqlDbType.Int, 10), new SqlParameter("@suppid", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@isopen", SqlDbType.Bit, 1), new SqlParameter("@payrate", SqlDbType.Decimal, 9), new SqlParameter("@isdefault", SqlDbType.Bit, 1) };
            commandParameters[0].Value = model.typeid;
            commandParameters[1].Value = model.suppid;
            commandParameters[2].Value = model.userid;
            commandParameters[3].Value = model.isopen;
        ...
        public bool Update(ChannelSupplier model)
        {
            ...
            builder.Append(" where typeid=@typeid and suppid=@suppid ");
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@isopen", SqlDbType.Bit, 1), new SqlParameter("@payrate", SqlDbType.Decimal, 9), new SqlParameter("@typeid", SqlDbType.Int, 10), new SqlParameter("@suppid", SqlDbType.Int, 10) };
