namespace KuaiCard.WebUI.Manage.News
{
    using KuaiCard.BLL;
    ...
    public class NewsEdit : ManagePageBase
    {
        ...
        protected void BtnSubmit_Click(object sender, EventArgs e)
        {
            ...
            string str2 = this.hfcontent.Value;
        ...
        private void ShowInfo()
        {
            ...
            {
                string name = Enum.GetName(typeof(NewsType), num);
                this.ddl_type.Items.Add(new ListItem(name, num.ToString()));
            }
