namespace KuaiCard.BLL
{
    ...
    public class IMSGFactory
    {
        ...
        public static int Add(IMSG model)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@msg_from", SqlDbType.Int, 10), new SqlParameter("@msg_to", SqlDbType.Int, 10), new SqlParameter("@msg_content", SqlDbType.NVarChar, 0x7d0), new SqlParameter("@msg_addtime", SqlDbType.DateTime), new SqlParameter("@msg_title", SqlDbType.NVarChar, 50), new SqlParameter("@msg_fromname", SqlDbType.NVarChar, 50) };
        ...
        public static IMSG GetModel(int ID, int msg_to)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@ID", SqlDbType.Int, 10), new SqlParameter("@msg_to", SqlDbType.Int, 10) };
            commandParameters[0].Value = ID;
        ...
        public static IMSG GetModelByTo(int msg_to)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@msg_to", SqlDbType.Int, 10) };
        ...
        public static bool Update(IMSG model)
        {
            ...
            builder.Append(" where ID=@ID");
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@msg_from", SqlDbType.Int, 10), new SqlParameter("@msg_to", SqlDbType.Int, 10), new SqlParameter("@msg_content", SqlDbType.NVarChar, 0x7d0), new SqlParameter("@msg_addtime", SqlDbType.DateTime), new SqlParameter("@msg_title", SqlDbType.NVarChar, 50), new SqlParameter("@ID", SqlDbType.Int, 10), new SqlParameter("@isRead", SqlDbType.Bit, 1) };
            commandParameters[0].Value = model.msg_from;
            commandParameters[1].Value = model.msg_to;
            commandParameters[2].Value = model.msg_content;
            commandParameters[3].Value = model.msg_addtime;
