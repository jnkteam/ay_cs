namespace OriginalStudio.BLL.BaseData
{
    ...
    {
        public static OriginalStudio.Model.BaseData.identitycard DataRowToModel(DataRow row)
        {
            OriginalStudio.Model.BaseData.identitycard identitycard = new OriginalStudio.Model.BaseData.identitycard();
            if (row != null)
            {
        ...
        public static OriginalStudio.Model.BaseData.identitycard GetModel(int ID)
        {
            StringBuilder builder = new StringBuilder();
        ...
        public static OriginalStudio.Model.BaseData.identitycard GetModel(string BM)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 ID,BM,DQ from base_identitycard ");
