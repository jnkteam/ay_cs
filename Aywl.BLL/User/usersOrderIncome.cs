namespace OriginalStudio.BLL.User
{
    ...
    public class usersOrderIncome
    {
        ...
        public static Int64 Add(UserInfo _userinfo)
        {
            try
            {
                SqlParameter parameter = DataBase.MakeOutParam("@id", SqlDbType.Int, 10);
                SqlParameter[] commandParameters = new SqlParameter[] { 
                    parameter, DataBase.MakeInParam("@userName", SqlDbType.VarChar, 50, _userinfo.UserName), DataBase.MakeInParam("@password", SqlDbType.VarChar, 100, _userinfo.Password), DataBase.MakeInParam("@cpsdrate", SqlDbType.Int, 10, _userinfo.CPSDrate), DataBase.MakeInParam("@cvsnrate", SqlDbType.Int, 10, _userinfo.CVSNrate), DataBase.MakeInParam("@email", SqlDbType.VarChar, 50, _userinfo.Email), DataBase.MakeInParam("@qq", SqlDbType.VarChar, 50, _userinfo.QQ), DataBase.MakeInParam("@tel", SqlDbType.VarChar, 50, _userinfo.Tel), DataBase.MakeInParam("@idCard", SqlDbType.VarChar, 50, _userinfo.IdCard), DataBase.MakeInParam("@account", SqlDbType.VarChar, 50, _userinfo.Account), DataBase.MakeInParam("@payeeName", SqlDbType.VarChar, 50, _userinfo.PayeeName), DataBase.MakeInParam("@payeeBank", SqlDbType.VarChar, 50, _userinfo.PayeeBank), DataBase.MakeInParam("@bankProvince", SqlDbType.VarChar, 50, _userinfo.BankProvince), DataBase.MakeInParam("@bankCity", SqlDbType.VarChar, 50, _userinfo.BankCity), DataBase.MakeInParam("@bankAddress", SqlDbType.VarChar, 50, _userinfo.BankAddress), DataBase.MakeInParam("@status", SqlDbType.TinyInt, 1, _userinfo.Status), 
                    DataBase.MakeInParam("@lastloginip", SqlDbType.VarChar, 50, _userinfo.LastLoginIp), DataBase.MakeInParam("@lastlogintime", SqlDbType.DateTime, 8, _userinfo.LastLoginTime), DataBase.MakeInParam("@regtime", SqlDbType.DateTime, 8, _userinfo.RegTime), DataBase.MakeInParam("@agentId", SqlDbType.Int, 10, _userinfo.AgentId), DataBase.MakeInParam("@siteName", SqlDbType.VarChar, 50, _userinfo.SiteName), DataBase.MakeInParam("@siteUrl", SqlDbType.VarChar, 100, _userinfo.SiteUrl), DataBase.MakeInParam("@userType", SqlDbType.Int, 10, (int) _userinfo.UserType), DataBase.MakeInParam("@userLevel", SqlDbType.Int, 10, (int) _userinfo.UserLevel), DataBase.MakeInParam("@maxdaytocashTimes", SqlDbType.Int, 10, _userinfo.MaxDayToCashTimes), DataBase.MakeInParam("@apiaccount", SqlDbType.BigInt, 8, _userinfo.APIAccount), DataBase.MakeInParam("@apikey", SqlDbType.VarChar, 50, _userinfo.APIKey), DataBase.MakeInParam("@pmode", SqlDbType.TinyInt, 1, _userinfo.PMode), DataBase.MakeInParam("@settles", SqlDbType.TinyInt, 1, _userinfo.Settles), DataBase.MakeInParam("@DESC", SqlDbType.VarChar, 0xfa0, _userinfo.Desc), DataBase.MakeInParam("@manageId", SqlDbType.Int, 10, _userinfo.manageId), DataBase.MakeInParam("@question", SqlDbType.NVarChar, 150, _userinfo.question), 
        ...
        {
            SqlParameter[] commandParameters = new SqlParameter[] { DataBase.MakeInParam("@orderNo", SqlDbType.VarChar, 30, OrderId), DataBase.MakeInParam("@userid", SqlDbType.Int, 10, userid) };
        ...
        public static int GetCurrent()
        {
            try
            {
                object obj2 = HttpContext.Current.Session["{10E6C4EE-54C1-4895-8CDE-202A5B3DD9E9}"];
                if (obj2 != null)
                {
                    SqlParameter[] commandParameters = new SqlParameter[] { DataBase.MakeInParam("@sessionId", SqlDbType.VarChar, 100, obj2) };
                    object obj3 = DataBase.ExecuteScalar(CommandType.StoredProcedure, "proc_users_getIdBySession", commandParameters);
        ...
        public static UserInfo GetModelFromDs(DataSet ds)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    info.Integral = long.Parse(ds.Tables[0].Rows[0]["Integral"].ToString());
                }
                if (ds.Tables[0].Rows[0]["maxdaytocashTimes"].ToString() != "")
                {
                    info.MaxDayToCashTimes = int.Parse(ds.Tables[0].Rows[0]["maxdaytocashTimes"].ToString());
        ...
        public static bool Update(UserInfo _userinfo, List<UsersUpdateLog> changeList)
        {
            ...
            SqlParameter[] parameterArray = new SqlParameter[] { 
                DataBase.MakeInParam("@id", SqlDbType.Int, 10, _userinfo.ID), DataBase.MakeInParam("@userName", SqlDbType.VarChar, 50, _userinfo.UserName), DataBase.MakeInParam("@password", SqlDbType.VarChar, 100, _userinfo.Password), DataBase.MakeInParam("@cpsdrate", SqlDbType.Int, 10, _userinfo.CPSDrate), DataBase.MakeInParam("@cvsnrate", SqlDbType.Int, 10, _userinfo.CVSNrate), DataBase.MakeInParam("@email", SqlDbType.VarChar, 50, _userinfo.Email), DataBase.MakeInParam("@qq", SqlDbType.VarChar, 50, _userinfo.QQ), DataBase.MakeInParam("@tel", SqlDbType.VarChar, 50, _userinfo.Tel), DataBase.MakeInParam("@idCard", SqlDbType.VarChar, 50, _userinfo.IdCard), DataBase.MakeInParam("@account", SqlDbType.VarChar, 50, _userinfo.Account), DataBase.MakeInParam("@payeeName", SqlDbType.VarChar, 50, _userinfo.PayeeName), DataBase.MakeInParam("@payeeBank", SqlDbType.VarChar, 50, _userinfo.PayeeBank), DataBase.MakeInParam("@bankProvince", SqlDbType.VarChar, 50, _userinfo.BankProvince), DataBase.MakeInParam("@bankCity", SqlDbType.VarChar, 50, _userinfo.BankCity), DataBase.MakeInParam("@bankAddress", SqlDbType.VarChar, 50, _userinfo.BankAddress), DataBase.MakeInParam("@status", SqlDbType.TinyInt, 1, _userinfo.Status), 
                DataBase.MakeInParam("@agentId", SqlDbType.Int, 10, _userinfo.AgentId), DataBase.MakeInParam("@siteName", SqlDbType.VarChar, 50, _userinfo.SiteName), DataBase.MakeInParam("@siteUrl", SqlDbType.VarChar, 100, _userinfo.SiteUrl), DataBase.MakeInParam("@userType", SqlDbType.Int, 10, (int) _userinfo.UserType), DataBase.MakeInParam("@userLevel", SqlDbType.Int, 10, (int) _userinfo.UserLevel), DataBase.MakeInParam("@maxdaytocashTimes", SqlDbType.Int, 10, _userinfo.MaxDayToCashTimes), DataBase.MakeInParam("@apiaccount", SqlDbType.BigInt, 8, _userinfo.APIAccount), DataBase.MakeInParam("@apikey", SqlDbType.VarChar, 50, _userinfo.APIKey), DataBase.MakeInParam("@DESC", SqlDbType.VarChar, 0xfa0, _userinfo.Desc), DataBase.MakeInParam("@pmode", SqlDbType.Int, 10, _userinfo.PMode), DataBase.MakeInParam("@updatetime", SqlDbType.DateTime, 8, DateTime.Now), DataBase.MakeInParam("@manageId", SqlDbType.Int, 10, _userinfo.manageId), DataBase.MakeInParam("@isRealNamePass", SqlDbType.TinyInt, 1, _userinfo.IsRealNamePass), DataBase.MakeInParam("@isEmailPass", SqlDbType.TinyInt, 1, _userinfo.IsEmailPass), DataBase.MakeInParam("@isPhonePass", SqlDbType.TinyInt, 1, _userinfo.IsPhonePass), DataBase.MakeInParam("@smsNotifyUrl", SqlDbType.NVarChar, 0xff, _userinfo.smsNotifyUrl), 
            ...
            using (SqlConnection connection = new SqlConnection(DataBase.ConnectionString))
            {
                ...
                try
                {
                    if (changeList != null)
                    {
                        ...
                        {
                            SqlParameter[] parameterArray2 = new SqlParameter[] { new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@field", SqlDbType.VarChar, 20), new SqlParameter("@oldValue", SqlDbType.VarChar, 100), new SqlParameter("@newvalue", SqlDbType.VarChar, 100), new SqlParameter("@Addtime", SqlDbType.DateTime), new SqlParameter("@editor", SqlDbType.VarChar, 50), new SqlParameter("@oIp", SqlDbType.VarChar, 50), new SqlParameter("@desc", SqlDbType.VarChar, 0xfa0) };
