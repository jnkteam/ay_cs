namespace KuaiCard.BLL.Payment
{
    ...
    public class PayKeyFactory
    {
        ...
        {
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@CardType", SqlDbType.Int, 10) };
        ...
        public void GetModel()
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@ptype", SqlDbType.Int, 10) };
        ...
        public void Update()
        {
            ...
            builder.Append(" where ptype=@ptype");
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@ptype", SqlDbType.Int, 10), new SqlParameter("@puserid", SqlDbType.VarChar, 100), new SqlParameter("@puserkey", SqlDbType.VarChar, 200), new SqlParameter("@pusername", SqlDbType.VarChar, 50), new SqlParameter("@postbankurl", SqlDbType.VarChar, 200), new SqlParameter("@postcardurl", SqlDbType.VarChar, 200), new SqlParameter("@postsmsurl", SqlDbType.VarChar, 200) };
            commandParameters[0].Value = this.ptype;
