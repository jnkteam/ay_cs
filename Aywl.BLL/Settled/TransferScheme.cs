namespace OriginalStudio.BLL.Settled
{
    ...
    {
        public int Add(OriginalStudio.Model.Settled.TransferScheme model)
        {
            ...
            return DBAccess.DataBase.ExecuteNonQuery(CommandType.Text, builder.ToString(), cmdParms);
        }

        public Model.Settled.TransferScheme DataRowToModel(DataRow row)
        {
            Model.Settled.TransferScheme transferscheme = new Model.Settled.TransferScheme();
            if (row != null)
            {
        ...
        public bool Delete(int id)
        {
            ...
            cmdParms[0].Value = id;
            return (DBAccess.DataBase.ExecuteNonQuery(CommandType.Text, builder.ToString(), cmdParms) > 0);
        ...
        public bool DeleteList(string idlist)
        {
            ...
            return (DBAccess.DataBase.ExecuteNonQuery(CommandType.Text, builder.ToString(), null) > 0);
        }
        ...
        public bool Exists(int id)
        {
            ...
            SqlParameter[] cmdParms = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10) };
            cmdParms[0].Value = id;
            return Convert.ToInt32(DBAccess.DataBase.ExecuteScalar(CommandType.Text, builder.ToString(), cmdParms)) > 0;
        }
        ...
        public int GetRecordCount(string strWhere)
        {
            ...
            string single = DataBase.ExecuteScalarToStr(CommandType.Text, builder.ToString(), null);
            if (single == "0")
            {
                return 0;
            }
        ...
        public bool Update(OriginalStudio.Model.Settled.TransferScheme model)
        {
            StringBuilder builder = new StringBuilder();
