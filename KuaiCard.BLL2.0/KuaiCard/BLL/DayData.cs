namespace KuaiCard.BLL
{
    ...
    public class DayData
    {
        ...
        {
            SqlParameter[] commandParameters = new SqlParameter[] { DataBase.MakeInParam("@AddTime", SqlDbType.DateTime, 8, begintime), DataBase.MakeInParam("@EndTime", SqlDbType.DateTime, 8, endtime), DataBase.MakeInParam("@UserId", SqlDbType.Int, 10, adid) };
            return DataBase.ExecuteDataset(CommandType.StoredProcedure, "Proc_SelectDayDataHH", commandParameters).Tables[0];
        }
