namespace KuaiCard.DAL.Withdraw
{
    ...
    public class channelwithdraw
    {
        public int Add(KuaiCard.Model.Withdraw.channelwithdraw model)
        {
            ...
            DbHelperSQL.RunProcedure("proc_channelwithdraw_ADD", (IDataParameter[]) parameterArray, out num);
            return (int) parameterArray[0].Value;
        }

        public KuaiCard.Model.Withdraw.channelwithdraw DataRowToModel(DataRow row)
        {
            KuaiCard.Model.Withdraw.channelwithdraw channelwithdraw = new KuaiCard.Model.Withdraw.channelwithdraw();
            if (row != null)
            {
        ...
        public bool Delete(int id)
        {
            ...
            DbHelperSQL.RunProcedure("proc_channelwithdraw_Delete", (IDataParameter[]) parameterArray, out rowsAffected);
        ...
        public KuaiCard.Model.Withdraw.channelwithdraw GetModel(int id)
        {
            ...
            parameterArray[0].Value = id;
            KuaiCard.Model.Withdraw.channelwithdraw channelwithdraw = new KuaiCard.Model.Withdraw.channelwithdraw();
            DataSet set = DbHelperSQL.RunProcedure("proc_channelwithdraw_GetModel", (IDataParameter[]) parameterArray, "ds");
        ...
        public KuaiCard.Model.Withdraw.channelwithdraw GetModelByBankName(string bankName)
        {
            ...
            KuaiCard.Model.Withdraw.channelwithdraw channelwithdraw = new KuaiCard.Model.Withdraw.channelwithdraw();
            DataSet set = DbHelperSQL.RunProcedure("proc_channelwithdraw_GetModelBybankName", (IDataParameter[]) parameterArray, "ds");
            if (set.Tables[0].Rows.Count > 0)
            {
                return this.DataRowToModel(set.Tables[0].Rows[0]);
            }
        ...
        public KuaiCard.Model.Withdraw.channelwithdraw GetModelByBankCode(string bankCode)
        {
            ...
            KuaiCard.Model.Withdraw.channelwithdraw channelwithdraw = new KuaiCard.Model.Withdraw.channelwithdraw();
            DataSet set = DbHelperSQL.RunProcedure("proc_channelwithdraw_GetModelByBackCode", (IDataParameter[])parameterArray, "ds");
        ...
        public bool Update(KuaiCard.Model.Withdraw.channelwithdraw model)
        {
            ...
            parameterArray[3].Value = model.supplier;
            parameterArray[4].Value = model.sort;
            DbHelperSQL.RunProcedure("proc_channelwithdraw_Update", (IDataParameter[]) parameterArray, out rowsAffected);
            return (rowsAffected > 0);
        }
    }
}
