    ...
    public class UserFactory
    {
        ...
        public static UserInfo GetBaseModelFromDs(DataSet ds)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    info.classid = long.Parse(ds.Tables[0].Rows[0]["classid"].ToString());
                }
                ...
                {
                    info.CPSDrate = Int64.Parse(ds.Tables[0].Rows[0]["CPSDrate"].ToString());
                }
                if (ds.Tables[0].Rows[0]["CVSNrate"].ToString() != "")
                {
                    info.CVSNrate = Int64.Parse(ds.Tables[0].Rows[0]["CVSNrate"].ToString());
                }
                ...
                {
                    info.Status = Int64.Parse(ds.Tables[0].Rows[0]["status"].ToString());
                }
                ...
                {
                    info.manageId = new Int32?(int.Parse(ds.Tables[0].Rows[0]["manageId"].ToString()));
                }
                ...
                {
                    info.IsPhonePass = Int64.Parse(ds.Tables[0].Rows[0]["isPhonePass"].ToString());
                }
                else
                {
                    info.IsPhonePass = 0;
                ...
                {
                    info.Settles = Int32.Parse(ds.Tables[0].Rows[0]["settles"].ToString());
                }
                else
                {
                    info.Settles = 1;
                ...
                {
                    info.isdebug = Int64.Parse(ds.Tables[0].Rows[0]["isdebug"].ToString());
                }
                //===2017.2.15add==========
                if (ds.Tables[0].Columns.IndexOf("settles_type") >= 0)
                {
                    if (ds.Tables[0].Rows[0]["settles_type"].ToString() != "")
                    {
                        info.settles_type = int.Parse(ds.Tables[0].Rows[0]["settles_type"].ToString());
                    }
                    else
                    {
                        info.settles_type = 0;
                ...
                //===2017.3.26add==========
                if (ds.Tables[0].Columns.IndexOf("random_subject") >= 0)
                {
                    if (ds.Tables[0].Rows[0]["random_subject"].ToString() != "")
                    {
                        info.random_subject = int.Parse(ds.Tables[0].Rows[0]["random_subject"].ToString());
                    }
                    else
                    {
                        info.random_subject = 0;
                    }
                }
                info.bank_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["bank_limit"].ToString());
                info.wx_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["wx_limit"].ToString());
                info.ali_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["ali_limit"].ToString());
                info.qq_limit = Convert.ToDecimal(ds.Tables[0].Rows[0]["qq_limit"].ToString());

                //2017.4.12 add
                info.default_themes = ds.Tables[0].Rows[0]["default_themes"].ToString();
        ...
        public static UserInfo GetModelFromDs(DataSet ds)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                info.accoutType = Convert.ToInt32(ds.Tables[0].Rows[0]["accoutType"].ToString());
                if (ds.Tables[0].Rows[0]["status"].ToString() != "")
                {
                ...
                {
                    info.Integral = Convert.ToInt64(ds.Tables[0].Rows[0]["Integral"].ToString());
                }
                if (ds.Tables[0].Rows[0]["maxdaytocashTimes"].ToString() != "")
                {
                    info.MaxDayToCashTimes = int.Parse(ds.Tables[0].Rows[0]["maxdaytocashTimes"].ToString());
                ...
                //====2017.3.26 add
                info.random_subject = int.Parse(ds.Tables[0].Rows[0]["random_subject"].ToString());
                info.service_channel = int.Parse(ds.Tables[0].Rows[0]["service_channel"].ToString());
