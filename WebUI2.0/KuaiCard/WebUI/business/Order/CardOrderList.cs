    ...
    public class CardOrderList : BusinessPageBase
    {
        ...
        protected void rptOrders_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            url = string.Concat(new object[] { 
                url, "&ctype=", this.ddlChannelType.SelectedValue, "&userid=", this.txtuserid.Text, "&ns=", this.ddlNotifyStatus.SelectedValue, "&ka=", this.txtCardNo.Text, "&stime=", this.StimeBox.Text, "&etime=", this.EtimeBox.Text, "&mid=", this.ddlmange.SelectedValue, "&orderid=", 
                this.txtOrderId.Text, "&userorder=", this.txtUserOrder.Text, "&supporder=", this.txtSuppOrder.Text, "&currpage=", this.Pager1.CurrentPageIndex
             });
            try
            {
                string str2;
