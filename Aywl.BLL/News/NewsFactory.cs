namespace OriginalStudio.BLL.News
{
    using DBAccess;
    ...
    public class NewsFactory
    {
        ...
        public static int Add(NewsInfo model)
        {
            try
            {
                SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@newsid", SqlDbType.Int, 10), new SqlParameter("@newstype", SqlDbType.TinyInt, 1), new SqlParameter("@newstitle", SqlDbType.NVarChar, 50), new SqlParameter("@addTime", SqlDbType.DateTime), new SqlParameter("@newscontent", SqlDbType.Text), new SqlParameter("@IsRed", SqlDbType.TinyInt, 1), new SqlParameter("@IsTop", SqlDbType.TinyInt, 1), new SqlParameter("@IsPop", SqlDbType.TinyInt, 1), new SqlParameter("@Isbold", SqlDbType.TinyInt, 1), new SqlParameter("@Color", SqlDbType.VarChar, 20), new SqlParameter("@release", SqlDbType.Bit) };
        ...
        public static bool Delete(int newsid)
        {
            try
            {
                SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@newsid", SqlDbType.Int, 10) };
