namespace KuaiCard.BLL.APP
{
    ...
    public class apprecharge
    {
        ...
        public int Add(KuaiCard.Model.APP.apprecharge model)
        {
            int num;
        ...
        public KuaiCard.Model.APP.apprecharge DataRowToModel(DataRow row)
        {
            KuaiCard.Model.APP.apprecharge apprecharge = new KuaiCard.Model.APP.apprecharge();
            if (row != null)
            {
        ...
        public KuaiCard.Model.APP.apprecharge GetModel(string orderid)
        {
        ...
        public bool Update(KuaiCard.Model.APP.apprecharge model)
        {
            int rowsAffected = 0;
            SqlParameter[] parameters = new SqlParameter[] { 
                new SqlParameter("@id", SqlDbType.Int, 10), 
