namespace KuaiCard.BLL.basedata
{
    ...
    {
        public static KuaiCard.Model.basedata.identitycard DataRowToModel(DataRow row)
        {
            KuaiCard.Model.basedata.identitycard identitycard = new KuaiCard.Model.basedata.identitycard();
            if (row != null)
            {
        ...
        public static KuaiCard.Model.basedata.identitycard GetModel(int ID)
        {
            StringBuilder builder = new StringBuilder();
        ...
        public static KuaiCard.Model.basedata.identitycard GetModel(string BM)
        {
            StringBuilder builder = new StringBuilder();
            builder.Append("select  top 1 ID,BM,DQ from base_identitycard ");
