namespace OriginalStudio.WebUI.business.User
{
    ...
    public class UserPayRateEdit : BusinessPageBase
    {
                    ...
                    if (!string.IsNullOrEmpty(payrate))
                    {
                        ...
                        foreach (string str2 in strArray)
                        {
                            ...
                            if (strArray2[0] == "980")
                            {
                                ...
                                this.txtp980.Text = num2.ToString("0.00");
                            }
                            else if (strArray2[0] == "990")
                            {
                                num2 = Convert.ToDecimal(strArray2[1]) * 100M;
                                this.txtp990.Text = num2.ToString("0.00");
                            }
                            else if (strArray2[0] == "1020")
                            {
                                num2 = Convert.ToDecimal(strArray2[1]) * 100M;
                                this.txtp1020.Text = num2.ToString("0.00");
                            }
                            if (strArray2[0] == "98")
                            {
                                num2 = Convert.ToDecimal(strArray2[1]) * 100M;
