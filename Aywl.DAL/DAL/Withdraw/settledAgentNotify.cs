namespace OriginalStudio.DAL.Withdraw
{
    ...
    public class settledAgentNotify
    {
        ...
        public int Add(OriginalStudio.Model.Withdraw.settledAgentNotify model)
        {
            ...
            DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentNotify_ADD", parameterArray);
        ...
        public OriginalStudio.Model.Withdraw.settledAgentNotify DataRowToModel(DataRow row)
        {
        ...
        public bool Delete(int id)
        {
            ...
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentNotify_Delete", parameterArray) > 0;
        }
        ...
        public OriginalStudio.Model.Withdraw.settledAgentNotify GetModel(int id)
        {
            ...
            parameterArray[0].Value = id;
            OriginalStudio.Model.Withdraw.settledAgentNotify notify = new OriginalStudio.Model.Withdraw.settledAgentNotify();
            DataSet set = DataBase.ExecuteDataset(CommandType.StoredProcedure, "proc_settledAgentNotify_GetModel", parameterArray);
        ...
        public bool Update(OriginalStudio.Model.Withdraw.settledAgentNotify model)
        {
            ...
            parameterArray[12].Value = model.ext3;
            parameterArray[13].Value = model.remark;
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentNotify_Update", parameterArray) > 0;
        }
    }
}
