        ...
        public static int Add(OrderConvern model)
        {
            try
            {
                SqlParameter[] prams = new SqlParameter[] { 
                    new SqlParameter("@ID", SqlDbType.Int, 10), new SqlParameter("@OkxrOrderId", SqlDbType.BigInt, 8), new SqlParameter("@OrigOutOrderId", SqlDbType.VarChar, 500), new SqlParameter("@OrigPayType", SqlDbType.Int, 10), new SqlParameter("@OrigPayPrice", SqlDbType.Money, 8), new SqlParameter("@OrigPromoney", SqlDbType.Money, 8), new SqlParameter("@OrigAgmoney", SqlDbType.Money, 8), new SqlParameter("@OrigProfit", SqlDbType.Money, 8), new SqlParameter("@Amount", SqlDbType.Money, 8), new SqlParameter("@Created", SqlDbType.DateTime), new SqlParameter("@ConvtPayType", SqlDbType.Int, 10), new SqlParameter("@ConvtOutOrderId", SqlDbType.VarChar, 500), new SqlParameter("@ConvtPayPrice", SqlDbType.Money, 4), new SqlParameter("@ConvtAgmoney", SqlDbType.Money, 8), new SqlParameter("@ConvtPromoney", SqlDbType.Money, 8), new SqlParameter("@ConvtProfit", SqlDbType.Money, 8), 
