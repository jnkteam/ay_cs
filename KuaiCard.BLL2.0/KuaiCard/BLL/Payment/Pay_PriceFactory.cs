namespace KuaiCard.BLL.Payment
{
    using DBAccess;
    using System;
    using System.Data;
    ...
    public class Pay_PriceFactory
    {
        ...
        public void GetModel(int pid)
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { new SqlParameter("@Pri_Type", SqlDbType.Int, 10) };
        ...
        public void Update()
        {
            ...
            SqlParameter[] commandParameters = new SqlParameter[] { 
                new SqlParameter("@Pri_Type", SqlDbType.Int, 10), new SqlParameter("@Pay_101", SqlDbType.VarChar, 50), new SqlParameter("@Pay_102", SqlDbType.VarChar, 50), new SqlParameter("@Pay_103", SqlDbType.VarChar, 50), new SqlParameter("@Pay_104", SqlDbType.VarChar, 50), new SqlParameter("@Pay_105", SqlDbType.VarChar, 50), new SqlParameter("@Pay_106", SqlDbType.VarChar, 50), new SqlParameter("@Pay_107", SqlDbType.VarChar, 50), new SqlParameter("@Pay_108", SqlDbType.VarChar, 50), new SqlParameter("@Pay_109", SqlDbType.VarChar, 50), new SqlParameter("@Pay_110", SqlDbType.VarChar, 50), new SqlParameter("@Pay_111", SqlDbType.VarChar, 50), new SqlParameter("@Pay_112", SqlDbType.VarChar, 50), new SqlParameter("@Pay_113", SqlDbType.VarChar, 50), new SqlParameter("@Pay_300", SqlDbType.VarChar, 50), new SqlParameter("@Pay_114", SqlDbType.VarChar, 50), 
