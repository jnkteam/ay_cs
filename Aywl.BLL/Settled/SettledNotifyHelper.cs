namespace OriginalStudio.BLL.User
{
    ...
    public class SettledNotifyHelper
    {
        private OriginalStudio.Model.Settled.SettledInfo _settlemodel = null;
        ...
        public OriginalStudio.Model.Settled.SettledInfo SettleModel
        {
            get
            {
                return this._settlemodel;
            }
            set
            {
                this._settlemodel = value;
            }
        }
    }
}
