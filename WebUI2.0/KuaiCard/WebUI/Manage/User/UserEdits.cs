namespace KuaiCard.WebUI.Manage.User
{
    ...
    public class UserEdits : ManagePageBase
    {
        ...
        protected DropDownList ddlsettles_type;     //2017.2.13 add
        protected DropDownList ddlrandom_subject;     //2017.3.26 add
        ...
        protected RadioButtonList rblservice_channel;
        ...
        protected TextBox txtbank_limit;
        protected TextBox txtweixin_limit;
        ...
        private void Save()
        {
            ...
            {
                string str16 = this.txtpassword2.Text.Trim();
            ...
            this.model.settles_type = settles_type;     //2017.2.13增加
            this.model.bank_limit = decimal.Parse(this.txtbank_limit.Text); //2017.2.15add
            this.model.wx_limit = decimal.Parse(this.txtweixin_limit.Text);
            this.model.ali_limit = decimal.Parse(this.txtali_limit.Text);
            this.model.qq_limit = decimal.Parse(this.txtqq_limit.Text);
            int itemInfoId = 0;
            this.model.full_name = this.txtfullname.Text;   //2017.2.18增加后台修改用户名
            //2017.3.26add
            this.model.service_channel = int.Parse(rblservice_channel.SelectedValue);
            this.model.random_subject = int.Parse(this.ddlrandom_subject.SelectedValue);
        ...
        private void ShowInfo()
        {
            if (this.isUpdate && (this.model != null))
            {
                ...
                this.rbl_settledmode.SelectedValue = this.model.Settles.ToString();     //结算方式
                ...
                //
                this.ddlsettles_type.SelectedValue = this.model.settles_type.ToString();        //2017.2.13add
                //
                this.txtbank_limit.Text = this.model.bank_limit.ToString();
                this.txtweixin_limit.Text = this.model.wx_limit.ToString();
                this.txtali_limit.Text = this.model.ali_limit.ToString();
                this.txtqq_limit.Text = this.model.qq_limit.ToString();

                this.rblservice_channel.SelectedValue = this.model.service_channel.ToString();        //2017.3.26add
                this.ddlrandom_subject.SelectedValue = this.model.random_subject.ToString();        //2017.3.26add

                hlSetting.Visible = this.rblservice_channel.SelectedValue == "1";
                hlSetting.NavigateUrl = "UserSupplierConfig.aspx?userid=" + this.ItemInfoId.ToString();
        ...
        protected void rblservice_channel_SelectedIndexChanged(object sender, EventArgs e)
        {
            hlSetting.Visible = this.rblservice_channel.SelectedValue == "1";
        }
    }
