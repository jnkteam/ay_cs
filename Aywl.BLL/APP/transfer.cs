        ...
        public int Add(TransferInfo model)
        {
            try
            {
                SqlParameter[] commandParameters = new SqlParameter[] { 
                    new SqlParameter("@id", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@status", SqlDbType.TinyInt, 1), new SqlParameter("@billingName", SqlDbType.NVarChar, 100), new SqlParameter("@bankname", SqlDbType.TinyInt, 1), new SqlParameter("@province", SqlDbType.NVarChar, 15), new SqlParameter("@city", SqlDbType.NVarChar, 15), new SqlParameter("@branch", SqlDbType.NVarChar, 100), new SqlParameter("@cardnum", SqlDbType.VarChar, 20), new SqlParameter("@payee", SqlDbType.NVarChar, 10), new SqlParameter("@tranAmt", SqlDbType.Decimal, 9), new SqlParameter("@charges", SqlDbType.Decimal, 9), new SqlParameter("@paybank", SqlDbType.TinyInt, 1), new SqlParameter("@email", SqlDbType.VarChar, 0x16), new SqlParameter("@mobile", SqlDbType.VarChar, 20), new SqlParameter("@iswarn", SqlDbType.TinyInt, 1), 
                    new SqlParameter("@warnday", SqlDbType.Int, 10), new SqlParameter("@processstatus", SqlDbType.TinyInt, 1), new SqlParameter("@processtime", SqlDbType.DateTime), new SqlParameter("@smsnotification", SqlDbType.Bit, 1), new SqlParameter("@field1", SqlDbType.NVarChar, 50), new SqlParameter("@field2", SqlDbType.NVarChar, 50), new SqlParameter("@remark", SqlDbType.NVarChar, 200)
                 };
