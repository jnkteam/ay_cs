namespace OriginalStudio.DAL.Withdraw
{
    ...
    public class settledAgentSummary
    {
        ...
        public int Add(OriginalStudio.Model.Withdraw.settledAgentSummary model)
        {
            int num;
            ...
            DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentSummary_ADD", parameterArray);
        ...
        public OriginalStudio.Model.Withdraw.settledAgentSummary DataRowToModel(DataRow row)
        {
            OriginalStudio.Model.Withdraw.settledAgentSummary summary = new OriginalStudio.Model.Withdraw.settledAgentSummary();
            if (row != null)
            {
        ...
        public bool Delete(int id)
        {
            ...
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentSummary_Delete", parameterArray) > 0;
        }
        ...
        public bool Exists(string lotno)
        {
            ...
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentSummary_Exists", parameterArray) == 1;
        }
        ...
        public OriginalStudio.Model.Withdraw.settledAgentSummary GetModel(int id)
        {
            SqlParameter[] parameterArray = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10) };
            parameterArray[0].Value = id;
            OriginalStudio.Model.Withdraw.settledAgentSummary summary = new OriginalStudio.Model.Withdraw.settledAgentSummary();
            DataSet set = DataBase.ExecuteDataset(CommandType.StoredProcedure, "proc_settledAgentSummary_GetModel", parameterArray);
        ...
        public int Insert(OriginalStudio.Model.Withdraw.settledAgentSummary summarymodel, List<OriginalStudio.Model.Withdraw.settledAgent> itemlist)
        {
            int num3;
            using (SqlConnection connection = new SqlConnection(DataBase.ConnectionString))
            {
                ...
                try
                {
                    ...
                    if (num > 0)
                    {
                        foreach (OriginalStudio.Model.Withdraw.settledAgent agent in itemlist)
                        {
                            int num2;
                            ...
                            DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgent_ADD2", parameterArray2);
                        }
                        transaction.Commit();
                        connection.Close();
                        return num;
        ...
        public bool Update(OriginalStudio.Model.Withdraw.settledAgentSummary model)
        {
            SqlParameter[] parameterArray = new SqlParameter[] { new SqlParameter("@id", SqlDbType.Int, 10), new SqlParameter("@userid", SqlDbType.Int, 10), new SqlParameter("@lotno", SqlDbType.VarChar, 30), new SqlParameter("@qty", SqlDbType.Int, 10), new SqlParameter("@succqty", SqlDbType.Int, 10), new SqlParameter("@amt", SqlDbType.Decimal, 9), new SqlParameter("@succamt", SqlDbType.Decimal, 9), new SqlParameter("@fee", SqlDbType.Decimal, 9), new SqlParameter("@realfee", SqlDbType.Decimal, 9), new SqlParameter("@totalamt", SqlDbType.Decimal, 9), new SqlParameter("@totalsuccamt", SqlDbType.Decimal, 13), new SqlParameter("@status", SqlDbType.TinyInt, 1), new SqlParameter("@addtime", SqlDbType.DateTime), new SqlParameter("@updatetime", SqlDbType.DateTime), new SqlParameter("@remark", SqlDbType.NVarChar, 100) };
            ...
            parameterArray[13].Value = model.updatetime;
            parameterArray[14].Value = model.remark;
            return DataBase.ExecuteNonQuery(CommandType.StoredProcedure, "proc_settledAgentSummary_Update", parameterArray) > 0;
        }
    }
}
