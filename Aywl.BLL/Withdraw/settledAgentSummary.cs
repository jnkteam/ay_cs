namespace OriginalStudio.BLL.Withdraw
{
    ...
    {
        private readonly OriginalStudio.DAL.Withdraw.settledAgentSummary dal = new OriginalStudio.DAL.Withdraw.settledAgentSummary();
        ...
        public List<OriginalStudio.Model.Withdraw.settledAgentSummary> DataTableToList(DataTable dt)
        {
            List<OriginalStudio.Model.Withdraw.settledAgentSummary> list = new List<OriginalStudio.Model.Withdraw.settledAgentSummary>();
            int count = dt.Rows.Count;
            if (count > 0)
            {
                for (int i = 0; i < count; i++)
                {
                    OriginalStudio.Model.Withdraw.settledAgentSummary item = this.dal.DataRowToModel(dt.Rows[i]);
                    if (item != null)
                    {
                        list.Add(item);
                    }
        ...
        public List<OriginalStudio.Model.Withdraw.settledAgentSummary> GetModelList(string strWhere)
        {
